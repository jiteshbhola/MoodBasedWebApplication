...
var songs = [{
        'name': 'Bolna', //name is a key,with value 'ikk kudi'
        'artist': 'Arijit Singh,Asees Kaur',
        'album': 'Kapoor & Sons',
        'duration': '3:33',
       'fileName': 'song/romantic/b.mp3',
       'image':'bol.jpg' 
    },
    {
        'name': 'Khaab',
        ...
        'album': 'Khaab',
        'duration': '3:21',
        'fileName': 'song/romantic/k.mp3',
        'image':'kha.jpg'
    },
    {
        'name': 'Mar Jayein(Reprise)',
        'artist': 'Atif Aslam',
        'album': 'Love Shuda',
        'duration': '4:08',
        'fileName': 'song/romantic/m.mp3',
        'image':'mar.jfif'
    },
    {
        'name': 'Ishq Mubarak',
